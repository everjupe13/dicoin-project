      ...
      >
        <span
          className={clsx(
            ...
            'dark:group-data-checked:bg-(--checkbox-checked-bg) dark:bg-white/5',
            // Border
            'group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-zinc-950/30 group-data-checked:bg-(--checkbox-checked-border) border border-zinc-950/15',
            'dark:group-data-checked:border-white/5 dark:group-data-hover:group-data-checked:border-white/5 dark:group-data-hover:border-white/30 dark:border-white/15',
            // Inner highlight shadow
            'after:absolute after:inset-0 after:rounded-[calc(0.3125rem-1px)] after:shadow-[inset_0_1px_--theme(--color-white/15%)]',
            'dark:group-data-checked:after:block dark:after:-inset-px dark:after:hidden dark:after:rounded-[0.3125rem]',
            // Focus ring
            ...
            // Forced colors mode
            'forced-colors:group-data-disabled:[--checkbox-check:Highlight] forced-colors:[--checkbox-check:HighlightText] forced-colors:[--checkbox-checked-bg:Highlight]',
            'dark:forced-colors:group-data-disabled:[--checkbox-check:Highlight] dark:forced-colors:[--checkbox-check:HighlightText] dark:forced-colors:[--checkbox-checked-bg:Highlight]',
            colors[color]
          )}
        >
          <svg
