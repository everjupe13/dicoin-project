  ...
  public render(): JSX.Element {
    ...
    return (
      <div className="row flex-grow-1 d-flex justify-content-center align-items-center">
        <div className="auth-container col rounded-lg border bg-white px-5 py-4">
          <div className="row mb-4 mt-2">
            Status:
            <span
              className={`${
                isAuthStatusPositive ? 'text-success' : 'text-danger'
              }`}
            >
              {authStatus}
            </span>
          ...
          {isShowError && (
            <div className="row text-danger justify-content-center my-3">
              {errorMessage}
            </div>
          )}
